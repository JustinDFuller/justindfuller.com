...
The local server was started with the Keychain-backed OAuth credential and the configured Drive folder. The credential was read from the existing macOS Keychain item; its value was never printed.
