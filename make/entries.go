...
var Entries = []ProjectEntry{
	{
		Title:          "Daily Dash",
		Slug:           "daily-dash",
		URL:            "https://daily-dash.justindfuller.com",
		FirstParagraph: "Daily Dash helps kids glide through every checklist with colorful cues, upbeat sounds, and a sprinkle of celebration at the finish line.",
